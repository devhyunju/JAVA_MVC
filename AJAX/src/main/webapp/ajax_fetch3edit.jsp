		...
		<script>
			...
			const searchMusic = async () => {
				...
				try{
					...
					const filteredSongs = data.results.filter(song =>
						song.trackName.toLowerCase().includes(query.toLowerCase())
						);
					displayAutocomplete(filteredSongs);
				} catch (error) {
					console.error(error);
				} finally {
